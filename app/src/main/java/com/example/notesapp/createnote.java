...
// lancer méthode ajout bloc-notes  en cliquant sur le bouton
        ...
        msavenote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
// sauvgarder le nom et le titre de bloc-note dans firebase  
